...
<p class="code-title">Function Calling 查询测试运行结果</p>
...
<div class="code-fold" markdown="1">
<p class="code-title">MCP Server 的 Tool、Resource 和 Prompt</p>
...
<div class="code-fold" markdown="1">
<p class="code-title">STDIO Server</p>
...
<div class="code-fold" markdown="1">
<p class="code-title">Streamable HTTP Server</p>
...
<div class="code-fold" markdown="1">
<p class="code-title">旧版 SSE Server</p>
...
<div class="code-fold" markdown="1">
<p class="code-title">本地 Agent 配置</p>
...
<div class="code-fold" markdown="1">
<p class="code-title">HTTP 模式启动</p>
...
<div class="code-fold" markdown="1">
<p class="code-title">远程 endpoint 配置</p>
